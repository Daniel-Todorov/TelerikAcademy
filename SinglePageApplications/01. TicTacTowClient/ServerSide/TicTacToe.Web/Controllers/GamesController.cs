namespace TicTacToe.Web.Controllers
{
    ...
    public class GamesController : BaseApiController
    {
        ...
        [HttpGet]
        public IHttpActionResult GetNumberOfAvailableGames()
        {
            var currentUserId = this.userIdProvider.GetUserId();

            var numberOfAvailableGames = this.data.Games.All()
                .Where(game => game.State == GameState.WaitingForSecondPlayer && game.FirstPlayerId != currentUserId)
            ...
            return Ok(numberOfAvailableGames);
        }
